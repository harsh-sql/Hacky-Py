...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            engine_talk('I am good thank you')
        
        elif 'who are you' in command:
            print('I am mini alexa, your virtual assistant master') 
            engine_talk('I am mini alexa, your virtual assistant master. how can i help you ??') 
        
        elif 'can you do' in command:
            print("i can play songs on YouTube, search wikipedia, tell you a joke, and can even tell you date and time, find your overflow and searches on google and detect your location too. How may i help you??")
            engine_talk("i can play songs on YouTube, search wikipedia, tell you a joke, and can even tell you date and time, find your overflow and searches on google and detect your location too. How may i help you??")
        ...
        elif 'who is better' in command:
            print('Go and fucking check youself')
            engine_talk('Go and fucking check yourself.')
...
print('Removing background noise...Please wait') 
engine_talk('Removing background noise...Please wait') 
print('\n') 
